...
def convert_dir(file_dict:dict, export_name:str):
    ...
    user_id = charlist2str(extra_data['user_id'])
    param_type_dict = {
        4:"睡眠记录",
        2:"闭环漫波刺激",
        8:"双耳差频训练",
    ...
    param_type = extra_data['start_record_reason']>>16
    param_type = param_type_dict.get(param_type, '未知范式')
