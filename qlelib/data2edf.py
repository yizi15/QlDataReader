...
class EdfHandle:
    ...
    def _export(self, handle:pyedflib.EdfWriter, start_time = None):
        ...
        if 'sample_frequency' in channel_info_list[0].keys():
            sample_rate = round(channel_info_list[0]['sample_frequency']*duraion_r)/duraion_r
        else:
    ...
    def get_edf_handle(self, filename:str) ->pyedflib.EdfWriter:
